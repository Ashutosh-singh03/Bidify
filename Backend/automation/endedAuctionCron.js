...
export const endedAuctionCron = () => {
    cron.schedule("*/1 * * * *", async () => {
        const now = Date.now(); // ✅ Fixed: Removed 'new' before Date.now()
